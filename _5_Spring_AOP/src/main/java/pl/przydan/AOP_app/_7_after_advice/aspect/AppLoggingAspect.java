...
public class AppLoggingAspect {
    ...
    @After("execution(* pl.przydan.AOP_app._7_after_advice.DAO.AccountDAO.*(..))")
    ...
    @AfterThrowing(
            pointcut = "execution(* pl.przydan.AOP_app._7_after_advice.DAO.AccountDAO.*(..))",
            throwing = "exception"
    )
    ...
    @AfterReturning(
            pointcut = "execution(*  pl.przydan.AOP_app._7_after_advice.DAO.AccountDAO.findAllAccounts(..))",
            returning = "result"
    )
    ...
    @Before("pl.przydan.AOP_app._7_after_advice.aspect.AopExpressions.forDaoPackageNoGettersSetters()")
